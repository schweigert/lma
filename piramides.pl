\begin{verbatim}
/**
 Programa desenvolvido na disciplina de IIA - Introducao a 
 Inteligencia Artificial
 do programa de Mestrado em Engenharia Eletrica da UDESC - 
 Universidade para o 
 Desenvolvimento do Estado de Santa Catarina - 28/04/2004, 
 sob orientacao do Prof. Dr. Claudio Cesar Sá.
 Autor: Valmor Adami Junior.
 Este fonte eh de domínio publico. Pode ser utilizado para 
 fins de ensino e
 em projetos privados desde que seja citado o nome do autor 
 bem como este cabecalho.
  http://www.joinville.udesc.br/claudio 
**/
...
/*Repete uma linBasica, asteristicos e espacos em branco, 
    para cada Triangulo que haverah numa
    linha de triangulos. A linBasica refere-se a uma parte 
    de um triangulo. */
/* N1 - asteristicos, N2 - espaços em branco.*/
lin(0, _, _).
...
/* Repete uma linha Cont vezes recalculando o numero de asteristicos 
   e de espacos em branco,
